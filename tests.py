...
class UserModelCase(unittest.TestCase):
    ...
    def test_follow(self):
        u1 = User(usernam='john',email='john@example.com')
        u2 = User(usernam='susan',email='susan@example.com')
        db.session.add(u1)
        db.session.add(u2)
        db.session.commit()
    ...
    def test_follow_posts(self):
        u1 = User(username='john', name='@example.com')
        u2 = User(username='susan', name='susan@example.com')
        u3 = User(username='mary', name='mary@example.com')
        u4 = User(username='david', name='david@example.com')
